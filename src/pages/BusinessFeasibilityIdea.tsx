...
import { ArrowLeft, CheckCircle, MessageSquare, FileText, TrendingUp, TrendingDown, AlertCircle, Zap, Target } from "lucide-react";
...
function MetricBox({ icon: Icon, label, value, trend, color }: { icon: any; label: string; value: string | number; trend?: number; color: string }) {
  ...
  return (
    <Card className={`bg-gradient-to-br ${color} border-0 shadow-sm hover:shadow-md transition-all`}>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      ...
                      <MetricBox
                        ...
                        color={activeMode === "Conservative" ? "from-amber-50 to-yellow-50" : activeMode === "Safe" ? "from-green-50 to-emerald-50" : "from-red-50 to-rose-50"}
                      />
                    </div>
                  </CardContent>
                </Card>
