...
export const competitorAnalysis: CompetitorAnalysis[] = [
  ...
  {
    id: "2",
    competitor: "StartupSoft",
    product: "Cloud Platform",
    price: 15.99,
    marketShare: 22.1,
    features: ["Basic Analytics", "Email Support", "Standard API"],
    position: "mid-market",
    lastUpdated: new Date("2024-12-11T09:15:00"),
  },
  {
    id: "3",
    competitor: "BudgetTech",
    product: "Lite Version",
    price: 8.99,
    marketShare: 35.2,
    features: ["Limited Features", "Community Support"],
    position: "budget",
